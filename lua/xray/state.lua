...
function M.load()
  ...
  M.severity_modes = {
    [vim.diagnostic.severity.ERROR] = get_bool(
      loaded_state.modes,
      "ERROR",
      vim.diagnostic.severity.ERROR,
      get_bool(loaded_state, "ERROR", vim.diagnostic.severity.ERROR, true)
    ),
    [vim.diagnostic.severity.WARN] = get_bool(
      loaded_state.modes,
      "WARN",
      vim.diagnostic.severity.WARN,
      get_bool(loaded_state, "WARN", vim.diagnostic.severity.WARN, true)
    ),
    [vim.diagnostic.severity.INFO] = get_bool(
      loaded_state.modes,
      "INFO",
      vim.diagnostic.severity.INFO,
      get_bool(loaded_state, "INFO", vim.diagnostic.severity.INFO, true)
    ),
    [vim.diagnostic.severity.HINT] = get_bool(
      loaded_state.modes,
      "HINT",
      vim.diagnostic.severity.HINT,
      get_bool(loaded_state, "HINT", vim.diagnostic.severity.HINT, true)
    ),
  }
